...
$total_pages_sql = "SELECT count(*) as cuantos FROM _alergias WHERE _id > '0' $nivelm $qryB";
		...
		<div class="container" style="margin-top: 175px;">
			<div class="row">
				<div class="col-md-6 box-admin-opt">
					...
					<?php 
					$van = 0;
					$qryR = "SELECT * FROM _alergias WHERE _id > '0' $nivelm $qryB ORDER BY _status LIMIT $offset, $no_of_records_per_page";
						  	...
						  	<div class="modal-dialog modal-dialog-centered position-relative" role="document">
						    	<div class="modal-content">
									...
									<div class="modal-body p-4">
										...
										<div class="row">
											<div class="col-md-8">
												<h5 class="mt-0 mb-3 pl-2 text-secondary"><b>Editar Alergia</b></h5>
											</div>
										</div>
										<div class="form-row">
						  	...
						  	<div class="modal-dialog modal-dialog-centered position-relative" role="document">
						    	<div class="modal-content">
									...
									<div class="modal-body p-4">
										...
										<div class="row">
											<div class="col-md-8">
												<h5 class="mt-0 mb-3 pl-2 text-secondary"><b>Eliminar Alergia</b></h5>
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-12">
												Esta seguro de querer eliminar la alergia: <b><?php echo $rowR["_nombre"];?></b>?
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-6">
			  	...
			  	<div class="modal-dialog position-relative" role="document">
				    <div class="modal-content">
						...
						<div class="modal-body p-5">
							...
							<form action="alergias.php" method="POST">
							<div class="row">
