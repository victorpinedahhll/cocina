		...
		<div class="row mb-5">
			<div class="col-md-12">
				<div class="esconder-movil">
					<div class="mb-3 h4-sidebar-nobg text-center bg-success" style="height: 43px; font-size: 16pt; padding-top: 2px; background: #17a2b8; text-shadow: 0px 1px 1px #1d527d;">
						<?php echo $titulo;?>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box-admin-opt pt-3">
						...
						<?php 
						$qryPac = "SELECT * FROM _pacientes_solicitudes ORDER by fecha_ingreso";
						...
						<div class="row py-2" style="background: <?php echo $bgcolor; ?>">
							...
							<div class="col-md-3">
								<a href="pacientes_formulario_editar.php?sol=<?php echo $rowPac["id"]; ?>" style="text-decoration: underline;">
