...
$total_pages_sql = "SELECT count(*) as cuantos FROM _tipo_menu WHERE id > '0' $nivelm $qryB";
...
<?php
$qryAg = "SELECT count(*) as cuantosag FROM _tipo_menu WHERE id > '0' $nivelm $qryB";
		...
		<div class="container" style="margin-top: 200px;">
			<div class="row">
				<div class="col-md-6 box-admin-opt">
					...
					<?php 
					$van = 0;
					$qryR = "SELECT * FROM _tipo_menu WHERE id > '0' $nivelm $qryB ORDER BY status LIMIT $offset, $no_of_records_per_page";
						  	...
						  	<div class="modal-dialog modal-dialog-centered position-relative" role="document">
						    	<div class="modal-content" style="background: linear-gradient(#f4f6f9, #dae4f4);">
									...
									<div class="modal-body p-4">
										...
										<div class="row">
											<div class="col-md-8">
												<h5 class="mt-0 mb-3 pl-2 text-info"><b>Eliminar Tipo Menu</b></h5>
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-12">
												Esta seguro de querer eliminar el tipo de menu: <b><?php echo $rowR["nombre"];?></b>?
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-6">
				...
				<div class="col-md-4 box-admin-opt">
					...
					<div class="row">
						<div class="col-md-8">
							<h5 class="mt-0 mb-3 pl-2 text-info"><b>Agregar Tipo Menu</b></h5>
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-12">
			  	...
			  	<div class="modal-dialog position-relative" role="document">
				    <div class="modal-content" style="background: linear-gradient(#f4f6f9, #dae4f4);">
						...
						<div class="modal-body p-5">
							...
							<form action="tipo_menus.php" method="POST">
							<div class="row">
