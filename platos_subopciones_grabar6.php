...
if (isset($_POST['submitformEdit']) && isset($_SESSION['logincook']) && $nvsessiontemp=="A") {
	...
	$qry = "UPDATE `_menus_subopciones4` SET nombre='$nombre', descripcion='$descri', status='$status' WHERE id='$idopc5' and idmenu='$idmenu' and idopcion='$idopc' and idopcion2='$idopc2' and idopcion3='$idopc3' and idopcion4='$idopc4'";

}

if (isset($_POST['submitformDel']) && isset($_SESSION['logincook']) && $nvsessiontemp=="A") {

	$qry = "UPDATE `_menus_subopciones4` SET status='E' WHERE id='$idopc5' and idmenu='$idmenu' and idopcion='$idopc' and idopcion2='$idopc2' and idopcion3='$idopc3' and idopcion4='$idopc4'";
