					...
					<div class="box-admin-opt">
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input type="text" class="form-control" value="<?php echo $dateEmail; ?>" disabled>
							</div>
							<div class="form-group col-md-6">
								<label>Código</label>
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input type="text" class="form-control" value="<?php echo $papellido; ?>" disabled>
							</div>
							<div class="form-group col-md-6">
								<label>Segundo Apellido</label>
								<input type="text" class="form-control" value="<?php echo $sapellido; ?>" disabled>
							</div>
						</div>
						<div class="form-row">
						...
						<div class="form-row">
							<div class="form-group col-md-12">
								...
								<select id="medico" class="form-control" onChange="cambia_medico()" required="required" disabled>
									...
									?>
									<option value="<?php echo $rowM2["cod_med12"]; ?>" <?php if($rowM2["cod_med12"]==$medico){ echo "selected"; } ?>><?php echo $rowM2["primer_apellido_med29"]; ?> <?php if(!empty($rowM2["segundo_apellido_med37"])){ echo $rowM2["segundo_apellido_med37"]; } ?>, <?php echo $rowM2["primer_nombre_med18"]; ?> <?php if(!empty($rowM2["segundo_nombre_med22"])){ echo $rowM2["segundo_nombre_med22"]; } ?></option>
									<?php } ?>
									<option value="999999" <?php if($rowM2["medico_tratante"]=="999999"){ echo "selected"; } ?>>OTRO</option>
								</select>

								<div id="otrobox" style="display: none;">
									<input type="text" class="form-control mt-3" placeholder="nombre médico" value="<?php echo $rowM2["medico_otro"]; ?>">
								</div>
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-12">
								...
								<textarea rows="4" class="form-control" disabled><?php echo $motivo; ?></textarea>
							</div>
