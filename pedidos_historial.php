                ...
                while ($rowH = $resH->fetch_assoc()){
                    ...
                    <div class="col-md-3">
                        <?php if($rowH["paciente"]=="SI"){?>
                            <h4 class="text-center py-3 mb-2" style="background: #002d59; color: #fff; border-radius: 4px;">Pedido paciente</h4>
                        <?php 
                        }else{
                            $visita++;
                             ?>
                            <h4 class="text-center py-3 mb-2" style="background: #002d59; color: #fff; border-radius: 4px;">Pedido visitante <?php echo $visita; ?></h4>
                        <?php } ?>
