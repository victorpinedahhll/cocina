...
header("Content-Type: text/html;charset=UTF-8");
 ...
 if(isset($_POST['submitfinal'])){
	...
	$nameM  = "";
 	...
 	$sql = "UPDATE _pacientes_solicitudes SET observaciones='$observaciones', status='2' WHERE id='$id'";
 	$conexion->query($sql);
	...
	$contenidoMail.="<h2 style='margin: 0 0 12px 0; color: #002d59;'><b>Solicitud de cocina finalizada</b></h2><br>\n";
