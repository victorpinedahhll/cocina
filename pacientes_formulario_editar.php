		...
		<div class="row mb-5">
			<div class="col-md-12">
				<div class="esconder-movil">
					<div class="mb-3 h4-sidebar-nobg text-center bg-success" style="height: 43px; font-size: 16pt; padding-top: 2px; text-shadow: 0px 1px 1px #1d527d;">
						<?php echo $titulo;?>
					</div>
				</div>
			</div>
					...
					<div class="box-admin-opt p-3 pb-0" style="background: #002d59; color: #fff;">
						<div class="form-row">
							<div class="form-group col-1">
								<label>Socilitud</label><br>
								<h2 class="text-warning">#<?php echo $idSol; ?></h2>
							</div>
					...
					<div class="box-admin-opt h-100">
						...
						while ($rowL = $rsL->fetch_assoc()){
							...
							<div class="col px-2 text-center">
								<?php if($idplato > "0"){ ?>
									<a name="#" class="btn btn-lg w-100" style="box-shadow: 5px 10px 10px -10px #808080; height: 60px; line-height: 40px; background: #<?php echo $btncol;?>; color: #<?php echo $txtcol;?>;">
										<?php echo $rowL["nombre"]; ?>
									</a>
								<?php }else{ ?>
									<a href="?sol=<?php echo $idSol; ?>&id=<?php echo $idPac; ?>&idtp=<?php echo $rowL["id"]; ?>&opt1=SI&van=<?php echo $van; ?>" class="btn btn-lg w-100" style="box-shadow: 5px 10px 10px -10px #808080; height: 60px; line-height: 40px; background: #<?php echo $btncol;?>; color: #<?php echo $txtcol;?>;">
										<?php echo $rowL["nombre"]; ?>
									</a>
								<?php } ?>
							</div>
							<?php if($idplato > "0"){ ?>
							<div class="col-3">
								<a href="?sol=<?php echo $idSol; ?>&id=<?php echo $idPac; ?>" class="btn btn-lg w-100" style="box-shadow: 5px 10px 10px -10px #808080; height: 60px; line-height: 40px; background: #fff; color: #000; border: 1px solid #C0C0C0;">Menu Principal</a>
							</div>
							<?php } ?>		
						<?php } ?>
						</div>
						...
						<div class="row">
							...
							?>
								<div class="col-4 px-2 mt-3 text-center">
									<a href="?sol=<?php echo $idSol; ?>&id=<?php echo $idPac; ?>&idtp=<?php echo $idplato; ?>&id2=<?php echo $row["id"]; ?>&opt2=SI&van=<?php echo $_GET["van"]; ?>" class="btn btn-lg w-100" style="font-size: 14pt; background: #<?php echo $btncol;?>; color: #<?php echo $txtcol; ?>; box-shadow: 5px 10px 10px -10px #808080; height: 60px; line-height: 16pt; <?php if(strlen($row["nombre"]) < 25){ echo "padding-top: 18px;"; } ?>">
										<?php echo $row["nombre"]; ?>
									</a>
								</div>
							<?php } ?>
						...
						<div class="row mt-2">
							...
							while ($row = $rs->fetch_assoc()){
								...
								if($rs1->num_rows > 0){
									...
									?>
									<div class="col-4 px-2 mt-3 text-center">
										<a href="?sol=<?php echo $idSol; ?>&id=<?php echo $idPac; ?>&idtp=<?php echo $_GET["idtp"]; ?>&id2=<?php echo $_GET["id2"]; ?>&id3=<?php echo $row["id"]; ?>&opt3=SI&van=<?php echo $_GET["van"];?>" class="btn btn-lg w-100" style="font-size: 14pt; background: #<?php echo $btncol;?>; color: #<?php echo $txtcol;?>; box-shadow: 5px 10px 10px -10px #808080; height: 60px; line-height: 16pt; <?php if(strlen($row["nombre"]) < 25){ echo "padding-top: 18px;"; } ?>">
											<?php echo $row["nombre"]; ?>
										</a>
									</div>
								<?php }else{ ?>	
									<div class="col-4 px-2 mt-3 text-center">
										<a href="platos_add.php?sol=<?php echo $idSol; ?>&idpac=<?php echo $idPac; ?>&key=<?php echo $keyForm; ?>&idmenu=<?php echo $idM; ?>&idprogra=<?php echo $row["id"]; ?>&tipo=2&idtp=<?php echo $idplato;?>&van=<?php echo $_GET["van"]; ?>" class="btn btn-lg w-100" style="font-size: 14pt; background: #<?php echo $btncol;?>; color: #<?php echo $txtcol;?>; box-shadow: 5px 10px 10px -10px #808080; height: 60px; line-height: 16pt; <?php if(strlen($row["nombre"]) < 25){ echo "padding-top: 18px;"; } ?>">
											<?php echo $row["nombre"]; ?>
										</a>
									</div>
								<?php } ?>
				...
				<div class="col-md-4">
					<div class="box-admin-opt">
						...
						<div class="row mt-3 mb-3">
							<div class="col-md-12">
								<h5 class="mt-0 mb-2 text-dark text-center p-2" style="background: #eee;border-radius: 4px;">Observaciones</h5>
